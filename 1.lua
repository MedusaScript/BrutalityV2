...
SOMEXHUBMODILE.Name = "KiA_Hub"
        ...
        MODILEGUISOMEXHUB.BackgroundColor3 = Color3.fromRGB(50,20,20)
...
local Library = Update:Window("KiA","9199672495",Enum.KeyCode.RightControl);
...
Main:Seperator("Welcome To KiA Hub Community")

Main:Button("Chua Co Discord",function()
    setclipboard("Chua Co Discord")
end)
