...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('FakhriXibir Hub') then
        makefolder('FakhriXibir Hub')
    end
    if not _G.Dis and not isfile('FakhriXibir Hub/'..Name..'.json') then
        writefile('FakhriXibir Hub/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('FakhriXibir Hub') and isfile('FakhriXibir Hub/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('FakhriXibir Hub/'..Name..'.json'))
...
if IKAI then
	do
		local ui = game.CoreGui:FindFirstChild("FakhriXibir Hub")
		if ui then
			ui:Destroy()
		end
	end
	...
	local Properties = {
		RoundFrame = {
			...
			Image = "    http://www.roblox.com/asset/?id=1536548834681153?id=5554237731",
		...
		Shadow = {
			Name = "Shadow",
			BackgroundTransparency = 1,
			Image = "    http://www.roblox.com/asset/?id=1536548834681153?id=5554236805",
			ScaleType = Enum.ScaleType.Slice,
		...
		Circle = {
			BackgroundTransparency = 1,
			Image = "    http://www.roblox.com/asset/?id=1536548834681153?id=5554831670"
		},
		CircleButton = {
			BackgroundTransparency = 1,
			AutoButtonColor = false,
		...
		Menu = {
			...
			AutoButtonColor = false,
			BackgroundTransparency = 1,
			Image = "    http://www.roblox.com/asset/?id=1536548834681153?id=5555108481",
			Size = UDim2.fromOffset(20,20),
			Position = UDim2.fromScale(1,0.5) - UDim2.fromOffset(25,10)
		},
		NavBar = {
			Name = "SheetToggle",
			Image = "    http://www.roblox.com/asset/?id=1536548834681153?id=5576439039",
			BackgroundTransparency = 1,
			Size = UDim2.fromOffset(20,20),
	...
	function library:Window(text,text2,text3,logo,keybind)
		...
		local FakhriXibir Hub = Instance.new("ScreenGui")
		FakhriXibir Hub.Name = "FakhriXibir Hub"
		FakhriXibir Hub.Parent = game.CoreGui
		FakhriXibir Hub.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

		local Main = Instance.new("Frame")
		Main.Name = "Main"
		Main.Parent = FakhriXibir Hub
		...
		do  local ui =  game:GetService("CoreGui"):FindFirstChild("FakhriXibir")  if ui then ui:Destroy() end end
		...
		ToggleImgUi.Image = "rbxassetid://1536548834681153   "
		--     http://www.roblox.com/asset/?id=1536548834681153?id=9605991378
	...
	do  local ui =  game:GetService("CoreGui"):FindFirstChild("FakhriXibirFPS")  if ui then ui:Destroy() end 
	local uix =  game:GetService("CoreGui"):FindFirstChild("FakhriXibirtime")  if uix then uix:Destroy() end end


	local FakhriXibirFPS = Instance.new("ScreenGui")
	local FakhriXibirtime = Instance.new("ScreenGui")
	...
	FakhriXibirFPS.Name = "FakhriXibirFPS"
	FakhriXibirFPS.Parent = game.CoreGui
	FakhriXibirFPS.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

	FakhriXibirtime.Name = "FakhriXibirtime"
	FakhriXibirtime.Parent = game.CoreGui
	FakhriXibirtime.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

	Framefps.Name = "Framefps"
	Framefps.Parent = FakhriXibirFPS
	...
	Frametime.Parent = FakhriXibirtime
	...
	ImageLabelfps.Image = "rbxassetid://1536548834681153   "
	...
	ImageLabeltime.Image = "rbxassetid://1536548834681153   "
	...
	Yedhee.TextTransparency = 1
		...
		function uitab:Tab(text,logo1)
			...
			function main:Button(text,callback)
				...
				IMGBUTTON.Image = "    http://www.roblox.com/asset/?id=1536548834681153?id=9606312215"
			...
			function main:Toggle(text,Imgidicon,config,callback)
				...
				imgLabelIcon.Image = "    http://www.roblox.com/asset/?id=1536548834681153?id="..Imgidicon
...
game.StarterGui:SetCore("SendNotification", {
	...
	Icon = "    http://www.roblox.com/asset/?id=1536548834681153?id=9610159123",
	Duration = 8
})
			...
			elseif _G.Setting_table.Human_Evo and not _G.Setting_table.Human_Evo_H and game.Players.LocalPlayer.Data.Race.Value == 'Human' then
				if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor","1") == 0 then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist","1") ~= -2 then
						...
						if not game.Players.LocalPlayer.Backpack:FindFirstChild("Flower 1") and not game.Players.LocalPlayer.Character:FindFirstChild("Flower 1") and game:GetService("Workspace"):FindFirstChild("Flower1") then
							if not YUIks then
								Text("Mencari Bunga, Mohon Tunggu!!!, Ga Sabaran Mandul :V")
								YUIks = true
							end
							repeat wait(1)
								TP2(game:GetService("Workspace"):FindFirstChild("Flower1").CFrame)
			...
			elseif _G.Setting_table.Skypiea_Evo and not _G.Setting_table.Skypiea_Evo_H and game.Players.LocalPlayer.Data.Race.Value == 'Skypiea' then
				if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor","1") == 0 then
					...
					elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1") ~= -2 then
						...
						elseif _G.Setting_table.Race_Hop then
							Text("Ga ada orang pake angel cuk")
							HopServer()
							wait(50)
						else
							Text("Ga ada orang pake angel cuk")
					...
					Text("Blom bisa, karena dia blom ada ")
					wait(5)
				end
			elseif _G.Setting_table.Fishman_Evo and not _G.Setting_table.Fishman_Evo_H and game.Players.LocalPlayer.Data.Race.Value == 'Fishman' then
				if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor","1") == 0 then
					...
					elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1") ~= -2 then
						...
						Text("Raja laut belum lahir (EMOTE BATU)")
...
function HopServer()
    if not _G.TP_Ser then
		...
		game.StarterGui:SetCore("SendNotification", {
			...
			Text = "กำลังหาเซิฟ",
			Icon = "    http://www.roblox.com/asset/?id=1536548834681153?id=9606070311",
			Duration = 25
		})
		local PlaceID = game.PlaceId
		local AllIDs = {}
